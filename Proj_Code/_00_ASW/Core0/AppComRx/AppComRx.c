 ...
 *********************************************************************************************************************/
  SG_Sig_Grp_0x302 SG_Sig_Grp_0x302_AppComRx;

  Rte_Read_SG_Sig_Grp_0x302_SG_Sig_Grp_0x302(&SG_Sig_Grp_0x302_AppComRx);

  Rte_Write_SG_Sig_Grp_0x302_SR_S_SG_Sig_Grp_0x302(&SG_Sig_Grp_0x302_AppComRx);
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << End of runnable implementation >>               DO NOT CHANGE THIS COMMENT!
 *********************************************************************************************************************/
}
