 ...
 * /ActiveEcuC/Nm/CN_DBCNetWork_05d62413[0:NmPassiveModeEnabled](value=false) (DefRef: /MICROSAR/Nm/NmChannelConfig/NmPassiveModeEnabled)
...
CONST(Nm_ChannelConfigType, NM_CONST) Nm_ChannelConfig[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */ ComMConf_ComMChannel_CN_DBCNetWork_05d62413,                 0u, NULL_PTR        }   /* [/ActiveEcuC/ComM/ComMConfigSet/CN_DBCNetWork_05d62413] */
};
#define NM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(Nm_NmFunctionTableType, NM_CONST) Nm_NmFunctionTable[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    GetLocalNodeIdentifier        GetNodeIdentifier        GetPduData        GetUserData        GetState        SetUserData        NetworkRelease        NetworkRequest        PassiveStartUp        RepeatMessageRequest              Referable Keys */
  { /*     0 */ CanNm_GetLocalNodeIdentifier, CanNm_GetNodeIdentifier, CanNm_GetPduData, CanNm_GetUserData, CanNm_GetState, CanNm_SetUserData, CanNm_NetworkRelease, CanNm_NetworkRequest, CanNm_PassiveStartUp, CanNm_RepeatMessageRequest }   /* [CanNm] */
};
#define NM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
