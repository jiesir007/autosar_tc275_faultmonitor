 ...
 *   Generation Time: 2026-04-04 11:50:05
...
/* User: [ADC0SR1_ISR, CanIsr_1, CounterIsr_SystemTimer_Core0, GTMTIM2SR7_ISR, XSignalIsr_OsCore0] */
...
#define OS_START_SEC_STACK_OSCORE0_TASK_PRIO34_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */

/* Shared Task stack: OsCore0_Task_Prio34 */
/* User: [OsTask_App10ms_Core0] */
OS_STACK_DECLARE(OsCfg_Stack_OsCore0_Task_Prio34_Dyn, OS_CFG_SIZE_OSCORE0_TASK_PRIO34_STACK);

#define OS_STOP_SEC_STACK_OSCORE0_TASK_PRIO34_VAR_NOINIT_UNSPECIFIED
#include "Os_MemMap_Stacks.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
...
/* User: [CanIsr_0, CounterIsr_SystemTimer_Core1, XSignalIsr_OsCore1] */
...
/*! Stack configuration data: OsCore0_Task_Prio34 */
CONST(Os_StackConfigType, OS_CONST) OsCfg_Stack_OsCore0_Task_Prio34 =
{
  /* .LowAddress  = */ OS_STACK_GETLOWADDRESS(OsCfg_Stack_OsCore0_Task_Prio34_Dyn),
  /* .HighAddress = */ OS_STACK_GETHIGHADDRESS(OsCfg_Stack_OsCore0_Task_Prio34_Dyn)
};
