...
CONST(ComM_UserType, COMM_CONST) ComM_User[2] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */   FALSE,                 1u,                   0u },  /* [CN_DBCNetWork_f94df0c8] */
  { /*     1 */   FALSE,                 2u,                   1u }   /* [CN_DBCNetWork_INTER1_b99b6675] */
};
#define COMM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(ComM_UserByteMaskType, COMM_CONST) ComM_UserByteMask[2] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */      0u,                0u },  /* [/ActiveEcuC/ComM/ComMConfigSet/CN_DBCNetWork_f94df0c8] */
  { /*     1 */      1u,                1u }   /* [/ActiveEcuC/ComM/ComMConfigSet/CN_DBCNetWork_INTER1_b99b6675] */
};
#define COMM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
