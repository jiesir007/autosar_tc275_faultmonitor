 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: BswM_Lcfg.c
 *   Generation Time: 2024-03-15 23:02:08
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_Disable_DM(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_Enable_DM(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_TX_Disable(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_TX_EnableNoinit(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_RX_Disable(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_RX_EnableNoinit(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx);
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_AL_SetKL15_WUSRC(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx);
...
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_DBCNetWork_05d62413_RX_DM(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx);
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_DBCNetWork_05d62413_TX(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx);
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_DBCNetWork_05d62413_RX(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx);
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_BswMRule_WakeUp_KL15PENDING(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx);
...
/*lint -restore */
CONST(BswM_ActionListsType, BSWM_CONST) BswM_ActionLists[22] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*    13 */ BswM_ActionList_AL_Request_ComM_FULL_COM                     },  /* [Priority: 0] */  /* [AL_AL_Request_ComM_FULL_COM] */
  { /*    14 */ BswM_ActionList_AL_Request_ComM_NO_COM                       },  /* [Priority: 0] */  /* [AL_AL_Request_ComM_NO_COM] */
  { /*    15 */ BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_Disable_DM      },  /* [Priority: 0] */  /* [AL_CC_AL_CN_DBCNetWork_05d62413_Disable_DM] */
  { /*    16 */ BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_Enable_DM       },  /* [Priority: 0] */  /* [AL_CC_AL_CN_DBCNetWork_05d62413_Enable_DM] */
  { /*    17 */ BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_TX_Disable      },  /* [Priority: 0] */  /* [AL_CC_AL_CN_DBCNetWork_05d62413_TX_Disable] */
  { /*    18 */ BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_TX_EnableNoinit },  /* [Priority: 0] */  /* [AL_CC_AL_CN_DBCNetWork_05d62413_TX_EnableNoinit] */
  { /*    19 */ BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_RX_Disable      },  /* [Priority: 0] */  /* [AL_CC_AL_CN_DBCNetWork_05d62413_RX_Disable] */
  { /*    20 */ BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_RX_EnableNoinit },  /* [Priority: 0] */  /* [AL_CC_AL_CN_DBCNetWork_05d62413_RX_EnableNoinit] */
  { /*    21 */ BswM_ActionList_AL_SetKL15_WUSRC                             }   /* [Priority: 0] */  /* [AL_AL_SetKL15_WUSRC] */
};
...
CONST(BswM_DeferredRulesType, BSWM_CONST) BswM_DeferredRules[8] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     7 */      11u }   /* [R_BswMRule_App_ComM_Request] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(BswM_EcuMWakeupMappingType, BSWM_CONST) BswM_EcuMWakeupMapping[2] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */ ((EcuM_WakeupSourceType)1u << (EcuM_WakeupSourceType)EcuMConf_EcuMWakeupSource_CN_DBCNetWork_05d62413),                  2u,                    1u },  /* [ECUM_WAKEUP_0, MRP_EcuMWakeupSource_CN_DBCNetWork_9ed72b09] */
...
CONST(BswM_ImmediateUserType, BSWM_CONST) BswM_ImmediateUser[4] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  { /*     0 */      0x01u,             3u,               0u },  /* [Name: CC_CanSMIndication_CN_DBCNetWork_05d62413] */  /* [MRP_CC_CanSMIndication_CN_DBCNetWork_05d62413, CANSM_CHANNEL_0] */
  { /*     1 */      0x03u,             4u,               3u },  /* [Name: EcuMWakeupSource_CN_DBCNetWork_9ed72b09]   */  /* [MRP_EcuMWakeupSource_CN_DBCNetWork_9ed72b09, ECUM_WAKEUP_0] */
  { /*     2 */      0x03u,             6u,               4u },  /* [Name: EcuMWakeupSource_ECUM_WKSOURCE_KL15]       */  /* [MRP_EcuMWakeupSource_ECUM_WKSOURCE_KL15, ECUM_WAKEUP_1] */
  { /*     3 */      0x03u,            14u,               6u }   /* [Name: ESH_State]                                 */  /* [MRP_ESH_State, GENERIC_1] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
CONST(BswM_RulesType, BSWM_CONST) BswM_Rules[16] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
    /* Index    Id   RuleStatesIdx  FctPtr                                           Referable Keys */
  { /*     0 */ 10u,            0u, BswM_Rule_ESH_RunToPostRun                },  /* [R_ESH_RunToPostRun, MRP_EcuMWakeupSource_CN_DBCNetWork_9ed72b09, MRP_EcuMWakeupSource_ECUM_WKSOURCE_KL15, MRP_ESH_State, MRP_ESH_ModeNotification, MRP_ESH_ComMIndication_CN_DBCNetWork_05d62413, MRP_ESH_RunRequest_0, MRP_ESH_RunRequest_1, MRP_ESH_SelfRunRequestTimer] */
  { /*     1 */ 11u,            1u, BswM_Rule_ESH_RunToPostRunNested          },  /* [R_ESH_RunToPostRunNested] */
  { /*     2 */ 12u,            2u, BswM_Rule_ESH_WaitToShutdown              },  /* [R_ESH_WaitToShutdown, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests] */
  { /*     3 */ 14u,            3u, BswM_Rule_ESH_WakeupToPrep                },  /* [R_ESH_WakeupToPrep, MRP_ESH_State, MRP_ESH_EcuM_GetPendingWakeupEvents, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_ModeNotification] */
  { /*     4 */ 13u,            4u, BswM_Rule_ESH_WaitToWakeup                },  /* [R_ESH_WaitToWakeup, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests] */
  { /*     5 */ 15u,            5u, BswM_Rule_ESH_WakeupToRun                 },  /* [R_ESH_WakeupToRun, MRP_ESH_State, MRP_ESH_EcuM_GetValidatedWakeupEvents, MRP_ESH_ComMPendingRequests, MRP_ESH_ModeNotification] */
  { /*     6 */  5u,            6u, BswM_Rule_ESH_InitToWakeup                },  /* [R_ESH_InitToWakeup, MRP_ESH_State] */
  { /*     7 */  8u,            7u, BswM_Rule_ESH_PostRunToPrepNested         },  /* [R_ESH_PostRunToPrepNested] */
  { /*     8 */  7u,            8u, BswM_Rule_ESH_PostRunNested               },  /* [R_ESH_PostRunNested] */
  { /*     9 */  6u,            9u, BswM_Rule_ESH_PostRun                     },  /* [R_ESH_PostRun, MRP_ESH_State, MRP_ESH_ModeNotification] */
  { /*    10 */  9u,           10u, BswM_Rule_ESH_PrepToWait                  },  /* [R_ESH_PrepToWait, MRP_ESH_State, MRP_ESH_ModeNotification] */
  { /*    11 */  1u,           11u, BswM_Rule_BswMRule_App_ComM_Request       },  /* [R_BswMRule_App_ComM_Request, MRP_ModeReq_App_ComM_Mode_Request] */
  { /*    12 */  3u,           12u, BswM_Rule_CC_CN_DBCNetWork_05d62413_RX_DM },  /* [R_CC_CN_DBCNetWork_05d62413_RX_DM, MRP_CC_CanSMIndication_CN_DBCNetWork_05d62413] */
  { /*    13 */  4u,           13u, BswM_Rule_CC_CN_DBCNetWork_05d62413_TX    },  /* [R_CC_CN_DBCNetWork_05d62413_TX, MRP_CC_CanSMIndication_CN_DBCNetWork_05d62413] */
  { /*    14 */  2u,           14u, BswM_Rule_CC_CN_DBCNetWork_05d62413_RX    },  /* [R_CC_CN_DBCNetWork_05d62413_RX, MRP_CC_CanSMIndication_CN_DBCNetWork_05d62413] */
  { /*    15 */  0u,           15u, BswM_Rule_BswMRule_WakeUp_KL15PENDING     }   /* [R_BswMRule_WakeUp_KL15PENDING, MRP_EcuMWakeupSource_ECUM_WKSOURCE_KL15] */
};
#define BSWM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "BswM_vMemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
CONST(BswM_RulesIndType, BSWM_CONST) BswM_RulesInd[14] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  ...
  /*     0 */       12u,  /* [MRP_CC_CanSMIndication_CN_DBCNetWork_05d62413] */
  /*     1 */       13u,  /* [MRP_CC_CanSMIndication_CN_DBCNetWork_05d62413] */
  /*     2 */       14u,  /* [MRP_CC_CanSMIndication_CN_DBCNetWork_05d62413] */
  /*     3 */        0u,  /* [MRP_EcuMWakeupSource_CN_DBCNetWork_9ed72b09] */
  /*     4 */        0u,  /* [MRP_EcuMWakeupSource_ECUM_WKSOURCE_KL15] */
  /*     5 */       15u,  /* [MRP_EcuMWakeupSource_ECUM_WKSOURCE_KL15] */
  /*     6 */        0u,  /* [MRP_ESH_State] */
  /*     7 */        2u,  /* [MRP_ESH_State] */
  /*     8 */        3u,  /* [MRP_ESH_State] */
  /*     9 */        4u,  /* [MRP_ESH_State] */
...
VAR(BswM_ActionListQueueUType, BSWM_VAR_NOINIT) BswM_ActionListQueue;  /* PRQA S 0759, 1514, 1533 */  /* MD_CSL_Union, MD_CSL_ObjectOnlyAccessedOnce, MD_CSL_ObjectOnlyAccessedOnce */
  ...
  /*    13 */  /* [AL_AL_Request_ComM_FULL_COM] */
  /*    14 */  /* [AL_AL_Request_ComM_NO_COM] */
  /*    15 */  /* [AL_CC_AL_CN_DBCNetWork_05d62413_Disable_DM] */
  /*    16 */  /* [AL_CC_AL_CN_DBCNetWork_05d62413_Enable_DM] */
  /*    17 */  /* [AL_CC_AL_CN_DBCNetWork_05d62413_TX_Disable] */
  /*    18 */  /* [AL_CC_AL_CN_DBCNetWork_05d62413_TX_EnableNoinit] */
  /*    19 */  /* [AL_CC_AL_CN_DBCNetWork_05d62413_RX_Disable] */
  /*    20 */  /* [AL_CC_AL_CN_DBCNetWork_05d62413_RX_EnableNoinit] */
  /*    21 */  /* [AL_AL_SetKL15_WUSRC] */
...
VAR(CanSM_BswMCurrentStateType, BSWM_VAR_NOINIT) BswM_CanSMChannelState[1];  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  /* Index        Referable Keys */
  /*     0 */  /* [CANSM_CHANNEL_0, MRP_CC_CanSMIndication_CN_DBCNetWork_05d62413] */
...
VAR(ComM_ModeType, BSWM_VAR_NOINIT) BswM_ComMChannelState[1];  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  /* Index        Referable Keys */
  /*     0 */  /* [COMM_CHANNEL_0, MRP_ESH_ComMIndication_CN_DBCNetWork_05d62413] */
...
VAR(BswM_ModeRequestQueueType, BSWM_VAR_NOINIT) BswM_ModeRequestQueue[4];  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  /* Index        Referable Keys */
  /*     0 */  /* [MRP_CC_CanSMIndication_CN_DBCNetWork_05d62413, CANSM_CHANNEL_0] */
...
VAR(BswM_RuleStatesUType, BSWM_VAR_NOINIT) BswM_RuleStates;  /* PRQA S 0759, 1514, 1533 */  /* MD_CSL_Union, MD_CSL_ObjectOnlyAccessedOnce, MD_CSL_ObjectOnlyAccessedOnce */
  ...
  /*     9 */  /* [R_ESH_PostRun] */
  /*    10 */  /* [R_ESH_PrepToWait] */
  /*    11 */  /* [R_BswMRule_App_ComM_Request] */
  /*    12 */  /* [R_CC_CN_DBCNetWork_05d62413_RX_DM] */
  /*    13 */  /* [R_CC_CN_DBCNetWork_05d62413_TX] */
  /*    14 */  /* [R_CC_CN_DBCNetWork_05d62413_RX] */
  /*    15 */  /* [R_BswMRule_WakeUp_KL15PENDING] */
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_RunToPostRun(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  ComM_CommunicationAllowed(ComMConf_ComMChannel_CN_DBCNetWork_05d62413, FALSE);
  ComM_CommunicationAllowed(ComMConf_ComMChannel_CN_DBCNetWork_INTER1_9768a826, FALSE);
  /*lint -save -e534 *//* PRQA S 3109, 3200 1 */ /* MD_MSR_14.3, MD_BSWM_3200 */
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_ESH_AL_WakeupToRun(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  ComM_CommunicationAllowed(ComMConf_ComMChannel_CN_DBCNetWork_05d62413, TRUE);
  ComM_CommunicationAllowed(ComMConf_ComMChannel_CN_DBCNetWork_INTER1_9768a826, TRUE);
  ...
  (void)ComM_RequestComMode(ComMConf_ComMUser_CN_DBCNetWork_INTER1_b99b6675, COMM_FULL_COMMUNICATION);
  BSWM_DUMMY_STATEMENT(partitionIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_AL_Request_ComM_FULL_COM(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  (void)ComM_RequestComMode(ComMConf_ComMUser_CN_DBCNetWork_f94df0c8, COMM_FULL_COMMUNICATION);
  BSWM_DUMMY_STATEMENT(partitionIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */
...
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_AL_Request_ComM_NO_COM(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  (void)ComM_RequestComMode(ComMConf_ComMUser_CN_DBCNetWork_f94df0c8, COMM_NO_COMMUNICATION);
  BSWM_DUMMY_STATEMENT(partitionIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  return E_OK;
}/* PRQA S 6010, 6030, 6050 */ /* MD_MSR_STPTH, MD_MSR_STCYC, MD_MSR_STCAL */

/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_Disable_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_Disable_DM(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_XB_SUP_F_oDBCNetWork_Rx_2e39ec3a, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_Enable_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_Enable_DM(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_XB_SUP_F_oDBCNetWork_Rx_2e39ec3a, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkDmControlInvocation();
  BSWM_DUMMY_STATEMENT(partitionIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  return E_OK;
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_TX_Disable
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_TX_Disable(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_XB_SUP_F_oDBCNetWork_Tx_78634bbc, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_XB_SUP_F_oDBCNetWork_Tx_78634bbc, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_TX_EnableNoinit
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_TX_EnableNoinit(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_XB_SUP_F_oDBCNetWork_Tx_78634bbc, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_XB_SUP_F_oDBCNetWork_Tx_78634bbc, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  BswM_MarkPduGroupControlInvocation(BSWM_GROUPCONTROL_NORMAL);
  BSWM_DUMMY_STATEMENT(partitionIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  return E_OK;
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_RX_Disable
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_RX_Disable(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_XB_SUP_F_oDBCNetWork_Rx_2e39ec3a, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_XB_SUP_F_oDBCNetWork_Rx_2e39ec3a, FALSE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_RX_EnableNoinit
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_RX_EnableNoinit(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduGroup(ComConf_ComIPduGroup_XB_SUP_F_oDBCNetWork_Rx_2e39ec3a, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
  /* PRQA S 0277, 3109, 3201, 3325 COMSETIPDU */ /* MD_BswM_0277, MD_BswM_3109, MD_BswM_3201, MD_BswM_3325 */ /*lint -e506 -e572 */
  BswM_SetIpduDMGroup(ComConf_ComIPduGroup_XB_SUP_F_oDBCNetWork_Rx_2e39ec3a, TRUE); /* SBSW_BSWM_IPDUGROUPVECTORCALL */
  /* PRQA L:COMSETIPDU */ /*lint +e506 +e572 */
...
/**********************************************************************************************************************
 *  BswM_ActionList_AL_SetKL15_WUSRC
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(Std_ReturnType, BSWM_CODE) BswM_ActionList_AL_SetKL15_WUSRC(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  BswM_SetWUSRC_KL15();
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CN_DBCNetWork_05d62413_RX_DM
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_DBCNetWork_05d62413_RX_DM(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST(partitionIdx);
  /* Evaluate logical expression CC_LE_CN_DBCNetWork_05d62413_RX_DM. */
  if(BswM_GetCanSMChannelState(0, 0u) == CANSM_BSWM_FULL_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_DBCNetWork_05d62413_RX_DM, partitionIdx) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_DBCNetWork_05d62413_RX_DM, BSWM_TRUE, partitionIdx);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_Enable_DM. */
      retVal = BSWM_ID_AL_CC_AL_CN_DBCNetWork_05d62413_Enable_DM;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_DBCNetWork_05d62413_RX_DM, partitionIdx) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_DBCNetWork_05d62413_RX_DM, BSWM_FALSE, partitionIdx);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_Disable_DM. */
      retVal = BSWM_ID_AL_CC_AL_CN_DBCNetWork_05d62413_Disable_DM;
    }
  }
  BSWM_DUMMY_STATEMENT(partitionIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  return retVal;
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CN_DBCNetWork_05d62413_TX
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_DBCNetWork_05d62413_TX(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST(partitionIdx);
  /* Evaluate logical expression CC_LE_CN_DBCNetWork_05d62413_TX. */
  if(BswM_GetCanSMChannelState(0, 0u) == CANSM_BSWM_FULL_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_DBCNetWork_05d62413_TX, partitionIdx) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_DBCNetWork_05d62413_TX, BSWM_TRUE, partitionIdx);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_TX_EnableNoinit. */
      retVal = BSWM_ID_AL_CC_AL_CN_DBCNetWork_05d62413_TX_EnableNoinit;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_DBCNetWork_05d62413_TX, partitionIdx) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_DBCNetWork_05d62413_TX, BSWM_FALSE, partitionIdx);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_TX_Disable. */
      retVal = BSWM_ID_AL_CC_AL_CN_DBCNetWork_05d62413_TX_Disable;
    }
  }
  BSWM_DUMMY_STATEMENT(partitionIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  return retVal;
...
/**********************************************************************************************************************
 *  BswM_Rule_CC_CN_DBCNetWork_05d62413_RX
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_CC_CN_DBCNetWork_05d62413_RX(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST(partitionIdx);
  /* Evaluate logical expression CC_LE_CN_DBCNetWork_05d62413_RX. */
  if(BswM_GetCanSMChannelState(0, 0u) != CANSM_BSWM_NO_COMMUNICATION)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_DBCNetWork_05d62413_RX, partitionIdx) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_DBCNetWork_05d62413_RX, BSWM_TRUE, partitionIdx);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_RX_EnableNoinit. */
      retVal = BSWM_ID_AL_CC_AL_CN_DBCNetWork_05d62413_RX_EnableNoinit;
    }
  }
  else
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_CC_CN_DBCNetWork_05d62413_RX, partitionIdx) != BSWM_FALSE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_CC_CN_DBCNetWork_05d62413_RX, BSWM_FALSE, partitionIdx);
      /* Return triggered action list BswM_ActionList_CC_AL_CN_DBCNetWork_05d62413_RX_Disable. */
      retVal = BSWM_ID_AL_CC_AL_CN_DBCNetWork_05d62413_RX_Disable;
    }
  }
  BSWM_DUMMY_STATEMENT(partitionIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  return retVal;
...
/**********************************************************************************************************************
 *  BswM_Rule_BswMRule_WakeUp_KL15PENDING
 *********************************************************************************************************************/
BSWM_LOCAL FUNC(BswM_HandleType, BSWM_CODE) BswM_Rule_BswMRule_WakeUp_KL15PENDING(BswM_PCPartitionConfigIdxOfPartitionIdentifiersType partitionIdx)
{
  BswM_HandleType retVal = BSWM_NO_ACTIONLIST(partitionIdx);
  /* Evaluate logical expression LE_BswMRule_WakeUp_KL15PENDING. */
  if(BswM_GetEcuMWakeupState(1, 0u) == ECUM_WKSTATUS_PENDING)
  {
    if( BswM_GetRuleStates(BSWM_ID_RULE_BswMRule_WakeUp_KL15PENDING, partitionIdx) != BSWM_TRUE ) /* COV_BSWM_TRIGGEREDRULEEXECUTION */
    {
      BswM_UpdateRuleStates(BSWM_ID_RULE_BswMRule_WakeUp_KL15PENDING, BSWM_TRUE, partitionIdx);
      /* Return triggered action list BswM_ActionList_AL_SetKL15_WUSRC. */
      retVal = BSWM_ID_AL_AL_SetKL15_WUSRC;
    }
  }
  else
  {
    BswM_UpdateRuleStates(BSWM_ID_RULE_BswMRule_WakeUp_KL15PENDING, BSWM_FALSE, partitionIdx);
    /* No false action list configured. */
  }
  BSWM_DUMMY_STATEMENT(partitionIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */
  return retVal;
