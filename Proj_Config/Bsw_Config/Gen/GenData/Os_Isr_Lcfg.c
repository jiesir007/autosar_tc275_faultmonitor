 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Os_Isr_Lcfg.c
 *   Generation Time: 2024-03-24 20:49:08
...
/*! Dynamic ISR data: ADC0SR1_ISR */
OS_LOCAL VAR(Os_IsrType, OS_VAR_NOINIT) OsCfg_Isr_ADC0SR1_ISR_Dyn;
...
/*! ISR configuration data: ADC0SR1_ISR */
CONST(Os_IsrHwConfigType, OS_CONST) OsCfg_Isr_ADC0SR1_ISR_HwConfig =
{
  /* .HwConfig                  = */ &OsCfg_Hal_IntIsr_ADC0SR1_ISR,
  /* .MapConfig                 = */ &OsCfg_Hal_IntIsrMap_ADC0SR1_ISR,
  /* .IsMapped                  = */ FALSE
}
;  
CONST(Os_IsrConfigType, OS_CONST) OsCfg_Isr_ADC0SR1_ISR =
{
  /* .Thread   = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_ADC0SR1_ISR,
    /* .Context               = */ &OsCfg_Hal_Context_OsCore0_Isr_Level5_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Isr_Core,
    /* .Dyn                   = */ OS_ISR_CASTDYN_ISR_2_THREAD(OsCfg_Isr_ADC0SR1_ISR_Dyn),
  ...
  /* .SourceConfig              = */ &OsCfg_Isr_ADC0SR1_ISR_HwConfig,
  /* .IsrId                     = */ ADC0SR1_ISR,
...
{
  OS_ISR_CASTCONFIG_ISR_2_ISR(OsCfg_Isr_ADC0SR1_ISR),
