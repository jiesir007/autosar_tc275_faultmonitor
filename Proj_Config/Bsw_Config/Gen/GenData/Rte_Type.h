...
# define Rte_TypeDef_E_Sig_0x302_Used_1
typedef uint16 E_Sig_0x302_Used_1;

# define Rte_TypeDef_E_Sig_0x302_Used_2
typedef uint8 E_Sig_0x302_Used_2;

# define Rte_TypeDef_E_Sig_0x302_Used_3
typedef uint8 E_Sig_0x302_Used_3;

# define Rte_TypeDef_F_AAA_Angle
typedef uint8 F_AAA_Angle;

# define Rte_TypeDef_F_Button1_State
typedef uint8 F_Button1_State;

# define Rte_TypeDef_F_Button2_State
typedef uint8 F_Button2_State;

# define Rte_TypeDef_F_Button3_State
typedef uint8 F_Button3_State;

# define Rte_TypeDef_F_Button4_State
typedef uint8 F_Button4_State;

# define Rte_TypeDef_F_Meg_E2E_Error
typedef uint8 F_Meg_E2E_Error;

# define Rte_TypeDef_F_Mes_Lost_Error
typedef uint8 F_Mes_Lost_Error;

# define Rte_TypeDef_F_PowerMode
typedef uint8 F_PowerMode;

# define Rte_TypeDef_F_Sig_0x214_Used_1
typedef uint16 F_Sig_0x214_Used_1;

# define Rte_TypeDef_F_Sig_0x214_Used_2
typedef uint16 F_Sig_0x214_Used_2;

# define Rte_TypeDef_F_Sig_0x214_Used_3
typedef uint16 F_Sig_0x214_Used_3;

# define Rte_TypeDef_F_Sig_0x214_Used_5
typedef uint16 F_Sig_0x214_Used_5;

# define Rte_TypeDef_Meg_Trigger_Type
typedef boolean Meg_Trigger_Type;

# define Rte_TypeDef_SupD_Checksum_0x300
typedef uint8 SupD_Checksum_0x300;

# define Rte_TypeDef_SupD_Checksum_0x304
typedef uint8 SupD_Checksum_0x304;

# define Rte_TypeDef_SupD_Counter_0x300
typedef uint8 SupD_Counter_0x300;

# define Rte_TypeDef_SupD_Counter_0x304
typedef uint8 SupD_Counter_0x304;

# define Rte_TypeDef_SupF_Checksum_0x212
typedef uint8 SupF_Checksum_0x212;

# define Rte_TypeDef_SupF_Counter_0x212
typedef uint8 SupF_Counter_0x212;

# define Rte_TypeDef_D_Button1_Control
typedef uint8 D_Button1_Control;

# define Rte_TypeDef_D_Button2_Control
typedef uint8 D_Button2_Control;

# define Rte_TypeDef_D_Button3_Control
typedef uint8 D_Button3_Control;

# define Rte_TypeDef_D_Button4_Control
typedef uint8 D_Button4_Control;

# define Rte_TypeDef_D_Led1_Control
typedef uint8 D_Led1_Control;

# define Rte_TypeDef_D_Led1_CtrlMode
typedef uint8 D_Led1_CtrlMode;

# define Rte_TypeDef_D_Led2_Control
typedef uint8 D_Led2_Control;

# define Rte_TypeDef_D_Led2_CtrlMode
typedef uint8 D_Led2_CtrlMode;

# define Rte_TypeDef_D_Led3_Control
typedef uint8 D_Led3_Control;

# define Rte_TypeDef_D_Led3_CtrlMode
typedef uint8 D_Led3_CtrlMode;

# define Rte_TypeDef_D_Led4_Control
typedef uint8 D_Led4_Control;

# define Rte_TypeDef_D_Led4_CtrlMode
typedef uint8 D_Led4_CtrlMode;

# define Rte_TypeDef_F_Led1_State
typedef uint8 F_Led1_State;

# define Rte_TypeDef_F_Led2_State
typedef uint8 F_Led2_State;

# define Rte_TypeDef_F_Led3_State
typedef uint8 F_Led3_State;

# define Rte_TypeDef_F_Led4_State
typedef uint8 F_Led4_State;
...
typedef struct
{
  F_Led1_State F_Led1_State;
  F_Led2_State F_Led2_State;
  F_Led3_State F_Led3_State;
  F_Led4_State F_Led4_State;
} SG_Sig_Grp_0x210;

# define Rte_TypeDef_SG_Sig_Grp_0x211
typedef struct
{
  F_Button1_State F_Button1_State;
  F_Button2_State F_Button2_State;
  F_Button3_State F_Button3_State;
  F_Button4_State F_Button4_State;
} SG_Sig_Grp_0x211;

# define Rte_TypeDef_SG_Sig_Grp_0x212
typedef struct
{
  F_PowerMode F_PowerMode;
  SupF_Checksum_0x212 SupF_Checksum_0x212;
  SupF_Counter_0x212 SupF_Counter_0x212;
} SG_Sig_Grp_0x212;

# define Rte_TypeDef_SG_Sig_Grp_0x213
typedef struct
{
  F_AAA_Angle F_AAA_Angle;
} SG_Sig_Grp_0x213;

# define Rte_TypeDef_SG_Sig_Grp_0x214
typedef struct
{
  F_Sig_0x214_Used_1 F_Sig_0x214_Used_1;
  F_Sig_0x214_Used_2 F_Sig_0x214_Used_2;
  F_Sig_0x214_Used_3 F_Sig_0x214_Used_3;
  F_Sig_0x214_Used_5 F_Sig_0x214_Used_5;
} SG_Sig_Grp_0x214;

# define Rte_TypeDef_SG_Sig_Grp_0x216
typedef struct
{
  F_Meg_E2E_Error F_Meg_E2E_Error;
  F_Mes_Lost_Error F_Mes_Lost_Error;
} SG_Sig_Grp_0x216;

# define Rte_TypeDef_SG_Sig_Grp_0x300
typedef struct
{
  D_Led1_Control D_Led1_Control;
  D_Led2_Control D_Led2_Control;
  D_Led3_Control D_Led3_Control;
  D_Led4_Control D_Led4_Control;
  SupD_Checksum_0x300 SupD_Checksum_0x300;
  SupD_Counter_0x300 SupD_Counter_0x300;
} SG_Sig_Grp_0x300;

# define Rte_TypeDef_SG_Sig_Grp_0x301
typedef struct
{
  D_Button1_Control D_Button1_Control;
  D_Button2_Control D_Button2_Control;
  D_Button3_Control D_Button3_Control;
  D_Button4_Control D_Button4_Control;
} SG_Sig_Grp_0x301;

# define Rte_TypeDef_SG_Sig_Grp_0x302
typedef struct
{
  E_Sig_0x302_Used_1 E_Sig_0x302_Used_1;
  E_Sig_0x302_Used_2 E_Sig_0x302_Used_2;
  E_Sig_0x302_Used_3 E_Sig_0x302_Used_3;
} SG_Sig_Grp_0x302;

# define Rte_TypeDef_SG_Sig_Grp_0x304
typedef struct
{
  D_Led1_CtrlMode D_Led1_CtrlMode;
  D_Led2_CtrlMode D_Led2_CtrlMode;
  D_Led3_CtrlMode D_Led3_CtrlMode;
  D_Led4_CtrlMode D_Led4_CtrlMode;
  SupD_Checksum_0x304 SupD_Checksum_0x304;
  SupD_Counter_0x304 SupD_Counter_0x304;
} SG_Sig_Grp_0x304;
...
extern CONST(SG_Sig_Grp_0x210, RTE_CONST) Rte_C_SG_Sig_Grp_0x210_0;

extern CONST(SG_Sig_Grp_0x211, RTE_CONST) Rte_C_SG_Sig_Grp_0x211_0;

extern CONST(SG_Sig_Grp_0x212, RTE_CONST) Rte_C_SG_Sig_Grp_0x212_0;

extern CONST(SG_Sig_Grp_0x213, RTE_CONST) Rte_C_SG_Sig_Grp_0x213_0;

extern CONST(SG_Sig_Grp_0x214, RTE_CONST) Rte_C_SG_Sig_Grp_0x214_0;

extern CONST(SG_Sig_Grp_0x216, RTE_CONST) Rte_C_SG_Sig_Grp_0x216_0;

extern CONST(SG_Sig_Grp_0x300, RTE_CONST) Rte_C_SG_Sig_Grp_0x300_0;

extern CONST(SG_Sig_Grp_0x301, RTE_CONST) Rte_C_SG_Sig_Grp_0x301_0;

extern CONST(SG_Sig_Grp_0x302, RTE_CONST) Rte_C_SG_Sig_Grp_0x302_0;

extern CONST(SG_Sig_Grp_0x304, RTE_CONST) Rte_C_SG_Sig_Grp_0x304_0;
...
extern VAR(SG_Sig_Grp_0x300, RTE_VAR_INIT) Rte_AppComRx_SG_Sig_Grp_0x300_SR_S_SG_Sig_Grp_0x300; /* PRQA S 3408, 1504 */ /* MD_Rte_3408, MD_MSR_Rule8.7 */
extern VAR(SG_Sig_Grp_0x301, RTE_VAR_INIT) Rte_AppComRx_SG_Sig_Grp_0x301_SR_S_SG_Sig_Grp_0x301; /* PRQA S 3408, 1504 */ /* MD_Rte_3408, MD_MSR_Rule8.7 */
extern VAR(SG_Sig_Grp_0x302, RTE_VAR_INIT) Rte_AppComRx_SG_Sig_Grp_0x302_SR_S_SG_Sig_Grp_0x302; /* PRQA S 3408, 1504 */ /* MD_Rte_3408, MD_MSR_Rule8.7 */
extern VAR(SG_Sig_Grp_0x304, RTE_VAR_INIT) Rte_AppComRx_SG_Sig_Grp_0x304_SR_S_SG_Sig_Grp_0x304; /* PRQA S 3408, 1504 */ /* MD_Rte_3408, MD_MSR_Rule8.7 */
extern VAR(Meg_Trigger_Type, RTE_VAR_INIT) Rte_AppCtrl_Meg_Trigger_State_0x214_SR_S_Meg_Trigger_State; /* PRQA S 3408, 1504 */ /* MD_Rte_3408, MD_MSR_Rule8.7 */
extern VAR(SG_Sig_Grp_0x210, RTE_VAR_INIT) Rte_AppCtrl_SG_Sig_Grp_0x210_SR_S_SG_Sig_Grp_0x210; /* PRQA S 3408, 1504 */ /* MD_Rte_3408, MD_MSR_Rule8.7 */
extern VAR(SG_Sig_Grp_0x211, RTE_VAR_INIT) Rte_AppCtrl_SG_Sig_Grp_0x211_SR_R_SG_Sig_Grp_0x211; /* PRQA S 3408, 1504 */ /* MD_Rte_3408, MD_MSR_Rule8.7 */
extern VAR(SG_Sig_Grp_0x212, RTE_VAR_INIT) Rte_AppCtrl_SG_Sig_Grp_0x212_SR_R_SG_Sig_Grp_0x212; /* PRQA S 3408, 1504 */ /* MD_Rte_3408, MD_MSR_Rule8.7 */
extern VAR(SG_Sig_Grp_0x213, RTE_VAR_INIT) Rte_AppCtrl_SG_Sig_Grp_0x213_SR_R_SG_Sig_Grp_0x213; /* PRQA S 3408, 1504 */ /* MD_Rte_3408, MD_MSR_Rule8.7 */
extern VAR(SG_Sig_Grp_0x214, RTE_VAR_INIT) Rte_AppCtrl_SG_Sig_Grp_0x214_SR_R_SG_Sig_Grp_0x214; /* PRQA S 3408, 1504 */ /* MD_Rte_3408, MD_MSR_Rule8.7 */
extern VAR(SG_Sig_Grp_0x216, RTE_VAR_INIT) Rte_AppCtrl_SG_Sig_Grp_0x216_SR_R_SG_Sig_Grp_0x216; /* PRQA S 3408, 1504 */ /* MD_Rte_3408, MD_MSR_Rule8.7 */
